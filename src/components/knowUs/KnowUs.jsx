...
const KnowUs = () => {
    return (
        <div>
            <h1 className="commonHeading center">Get to know <span className="common-pink">us</span></h1>
            <div className={styles.container}>
                ...
                <div className={styles.row}>
                    ...
                    <div className={styles.rightSide}>
                        <h2 className={`commonHeading`} ><span className="common-pink">Teamwork</span> is the key to our success</h2>
                ...
                <div className={`${styles.row} ${styles.reverse}`}>
                    <div className={styles.rightSide}>
                        <h2 className={`commonHeading`} >We are all in for the <span className="common-pink">environment</span></h2>
